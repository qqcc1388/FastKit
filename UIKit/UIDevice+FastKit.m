...
+ (NSString *)devicePlatformString
{
    ...
    if ([platform isEqualToString:@"iPhone10,1"]) return @"iPhone 8 (Global)"; // Global
    if ([platform isEqualToString:@"iPhone10,2"]) return @"iPhone 8 Plus"; //(A1864/A1898/A1899) Global
    if ([platform isEqualToString:@"iPhone10,3"]) return @"iPhone X (Global)"; // A1865/A1902
    if ([platform isEqualToString:@"iPhone10,4"]) return @"iPhone 8 (GSM)"; //  A1905
    if ([platform isEqualToString:@"iPhone10,5"]) return @"iPhone 8 Plus (GSM)"; //  A1897
    if ([platform isEqualToString:@"iPhone10,6"]) return @"iPhone X (GSM)"; // A1901
    ...
    if ([platform isEqualToString:@"iPad14,1"])     return @"iPad Mini 6 (WiFi)";
    if ([platform isEqualToString:@"iPad14,2"])     return @"iPad Mini 6 (Cellular)";
